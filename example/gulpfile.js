...
const fs = require('fs')
const examples = ['simple', 'app_with_modules', 'app_with_boot_and_ext_modules']
...
function watchFiles () {
  ...
  watch(['../target/js/boot.js', '../target/js/CacheSupport.js'], { delay: 500 }, syncBoot)
  watch('../target/js/libs/*', { delay: 500 }, syncLibs)
}
